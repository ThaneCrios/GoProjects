...
type CollectorsRepository interface {
	GetCollectorByUUID(ctx context.Context, uuid string) (*models.User, error)
	CreateCollector(ctx context.Context, collector *models.User) (*models.User, error)
	UpdateCollector(ctx context.Context, collector *models.User, event *models.Event) (*models.User, error)
	DeleteCollector(ctx context.Context, uuid string, event *models.Event) error
}

func (p *Pg) GetCollectorByUUID(ctx context.Context, uuid string) (*models.User, error) {
...
func (p *Pg) CreateCollector(ctx context.Context, collector *models.User) (*models.User, error) {
	timeout, cancelFunc := context.WithTimeout(ctx, queryTimeout)
	defer cancelFunc()
...
func (p *Pg) UpdateCollector(ctx context.Context, collector *models.User, event *models.Event) (*models.User, error) {
	timeout, cancelFunc := context.WithTimeout(ctx, queryTimeout)
	defer cancelFunc()
...
func (p *Pg) DeleteCollector(ctx context.Context, uuid string, event *models.Event) error {
	timeout, cancelFunc := context.WithTimeout(ctx, queryTimeout)
	defer cancelFunc()
	err := p.CheckExistsByUUID(ctx, &models.User{}, uuid)
	if err != nil {
		return err
	}
