...
type ProductsRepository interface {
	...
	GetProductByBarCode(ctx context.Context, barCode string) (models.ProductWithBarCode, error)
...
func (p *Pg) GetProductByBarCode(ctx context.Context, barCode string) (models.ProductWithBarCode, error) {
	timeout, cancelFunc := context.WithTimeout(ctx, queryTimeout)
	defer cancelFunc()
